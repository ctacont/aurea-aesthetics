...
const TREATMENTS = [
  ...
  {
    title_de: 'Faltenbehandlung',
    title_en: 'Wrinkle Treatment',
    description_de: 'Glättet mimische Falten sanft durch gezielte Muskelentspannung – für einen entspannten, frischen Ausdruck bei voll erhaltener Natürlichkeit.',
    description_en: 'Gently smooths expression lines through targeted muscle relaxation — for a refreshed, naturally vibrant appearance.',
