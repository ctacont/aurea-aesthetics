    ...
    <section className="bg-background py-24 lg:py-40">
      <div className="px-6 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <Reveal  delay={480} className="-translate-x-[50%] duration-[1800ms]"><Eyebrow>{t('treatmentMatrix.eyebrow')}</Eyebrow></Reveal>
          <Reveal delay={680}  className="translate-x-[50%] duration-[1800ms]">
