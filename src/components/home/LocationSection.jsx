  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl px-6 py-24 text-white lg:px-16 lg:py-40">
        ...
        {/* Wir übergeben direction="left", damit die Reveal-Komponente weiß, woher sie sliden soll */}
        ...
        <Reveal delay={220} direction="left">
        ...
        <Reveal delay={340} direction="left">
        ...
        <Reveal delay={460} direction="left">
        ...
        <Reveal delay={580} direction="left">
