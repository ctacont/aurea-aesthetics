...
export default function LocationSection({ settings }) {
  ...
  return (
    <section className="grid lg:grid-cols-2">
      ...
      <div className="relative z-10 order-1 flex flex-col justify-center px-6 py-6 lg:order-2 lg:-ml-14 lg:my-14 lg:shadow-[0_24px_70px_rgba(0,0,0,0.08)] border border-white/15 bg-white/35 backdrop-blur-xl lg:w-fit bg-[#fff]/80 lg:px-6 lg:py-6">
