...
<div className="relative z-10 max-w-2xl px-6 py-24 text-white lg:px-16 lg:py-40">
  ...
  <Reveal
    delay={220}
    className="-translate-x-[25%] duration-[1900ms]"
  >
  ...
  <Reveal
    delay={460}
    className="-translate-x-[25%] duration-[2100ms]"
  >
  ...
  <Reveal
    delay={580}
    className="-translate-x-[25%] duration-[2200ms]"
  >
  ...
  <Reveal
    delay={700}
    className="-translate-x-[25%] duration-[2300ms]"
  >
    <Link
