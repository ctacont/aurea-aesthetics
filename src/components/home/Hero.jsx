    ...
    <section
      ...
      <div className="relative flex w-full items-end px-6 pb-20 pt-44 lg:px-16 lg:pb-28 lg:pt-52">
        <div
          ...
          <h1 className={` mt-7 font-heading text-[2.4rem] font-light leading-[1.1] [text-shadow:0_4px_30px_rgba(0,0,0,0.45)] md:text-[3.4rem] transition-all duration-[2300ms] ease-[cubic-bezier(0.16,1,0.3,1)]  ${stagger()}`} style={delayStyle(140)}>
            {t('hero.title')}
