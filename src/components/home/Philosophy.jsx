...
export default function Philosophy() {
  ...
  return (
    <section>
      <div>
        <Reveal delay={160} className="-translate-x-[50%]">
          <Eyebrow>{t('philosophy.eyebrow')}</Eyebrow>
        </Reveal>

        <Reveal delay={280} className="-translate-x-[50%]">
          <h2 className="mt-8 max-w-6xl font-heading text-[2.1rem] font-light leading-[1.15] md:text-5xl">
            {t('philosophy.title')}
        ...
        <div className="mt-16 grid gap-14 lg:grid-cols-12 lg:gap-16">
          <Reveal delay={340} className="lg:col-span-5 -translate-x-[50%]">
            <div ref={parallaxRef} className="group relative aspect-[4/5] w-full overflow-hidden hasan10">
              <div
          ...
          <div className="lg:col-span-7 lg:pt-6">
            <Reveal delay={200} className="lg:col-span-7 lg:pt-6 -translate-x-[50%]">
              <p className="text-lg leading-[1.75] text-neutral-700">
                {t('philosophy.body')}
              </p>
            </Reveal>

            <Reveal delay={400} className="-translate-x-[50%]">
