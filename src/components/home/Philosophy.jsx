    ...
    <section className="overflow-hidden px-6 py-24 lg:px-12 lg:py-32">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-16 grid gap-14 lg:grid-cols-12 lg:gap-16">
          ...
          <Reveal
            delay={340}
            className="lg:col-span-5 -translate-x-[50%] duration-[2200ms]"
          >
            <div
              ref={parallaxRef}
              className="group relative aspect-[4/5] w-full overflow-hidden hasan10"
            >
              <div
                style={{
