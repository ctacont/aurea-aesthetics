  ...
  return (
    <section className="overflow-hidden px-6 py-24 lg:px-12 lg:py-32">
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-12 lg:gap-14">
        ...
        <Reveal
          delay={100}
          className={`lg:col-span-6 duration-[1800ms] ${
            reversed
              ? 'lg:order-1 lg:col-start-1 -translate-x-[20%]'
              : 'lg:col-start-7 translate-x-[20%]'
          } lg:pl-2`}
        >
          {doctor.specialty && (
          ...
          {bio && (
            <p className="mt-6 text-lg leading-[1.75] text-neutral-700">
              {bio}
            </p>
          )}

          <p className="eyebrow mt-8 text-neutral-500">
            {t('aerztinnen.languagesLabel')}: {t('aerztinnen.languages')}
          </p>
