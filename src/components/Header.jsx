      ...
      <header
        ...
        <div className="flex items-center justify-between px-6 py-5 lg:px-12">
          <Link to="/" className="flex items-center" aria-label="Aurea Aesthetics — Startseite">
            ...
            className="w-auto brightness-0 invert h- lg:h-1" />
          ...
          <nav className="hidden items-center gap-9 lg:flex" aria-label="Hauptnavigation">
            ...
            <div key={n.path} onMouseEnter={() => setMega(!!n.mega)}>
                ...
                pathname.startsWith(n.path) ? 'text-[#C9AF80]' : 'text-white/75 hover:text-white'}`
                }>
          ...
          <div className="flex items-center gap-5">
            <Link
              to="/kontakt-termin"
              className="hidden border border-white/25 px-6 py-3 eyebrow text-white transition-colors duration-500 hover:border-[#C9AF80] hover:bg-[#C9AF80] hover:text-[#0A0A0A] lg:inline-block">
